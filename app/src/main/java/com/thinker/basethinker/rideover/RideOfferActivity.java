...
public class RideOfferActivity extends MvpActivity<RideOfferPrsenter, MvpView> implements MvpView, View.OnClickListener, AdapterView.OnItemClickListener {
    private RideOfferPrsenter presenter;
    ...
    @Override
    protected RideOfferPrsenter CreatePresenter() {
        return presenter = new RideOfferPrsenter(this);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        presenter.findCouponListUsingPOST();
    }
