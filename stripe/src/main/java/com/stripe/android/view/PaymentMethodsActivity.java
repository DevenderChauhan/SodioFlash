    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("farley", "selectedSource=" + selectedSource.toJson());
//                for (CustomerSource customerSource:mCustomer.getSources()) {
//                    Log.d("farley", "customerSource=" + customerSource.toJson());
//                    if (selectedSource.getId().equals(customerSource)){
//                        mCustomer.getSources().get(0)
//                    }
//                }
            }
        });
